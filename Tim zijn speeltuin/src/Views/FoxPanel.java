...
public class FoxPanel {
	...
	public FoxPanel()
	{
		...
		JTextField newFoxBreedingAge = new JTextField();
		...
		JTextField newFoxMaxAge = new JTextField();
		...
		JTextField newFoxBreedingProbability = new JTextField();
		...
		JTextField newFoxMaxLitterSize = new JTextField();
		...
		JTextField newFoxFoodValue = new JTextField();

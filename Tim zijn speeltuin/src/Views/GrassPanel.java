...
public class GrassPanel {
	...
	public GrassPanel()
	{
		...
		JTextField newGrassBreedingAge = new JTextField();
		...
		JTextField newGrassMaxAge = new JTextField();
		...
		JTextField newGrassBreedingProbability = new JTextField();
		...
		JTextField newGrassMaxLitterSize = new JTextField();
